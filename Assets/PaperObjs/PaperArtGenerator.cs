...
public class PaperArtGenerator : MonoBehaviour
{
    ...
    public void InitPlane()
    {
        ...
        float widthOff = planeTexture.width / scaleOffset_Plane;
        float heightOff = planeTexture.height / scaleOffset_Plane;
        ...
        vertices[0] = new Vector3(-widthOff / 2, -heightOff / 2);
        vertices[1] = new Vector3(-widthOff / 2, heightOff / 2);
        vertices[2] = new Vector3(widthOff / 2, heightOff / 2);
        vertices[3] = new Vector3(widthOff / 2, -heightOff / 2);
